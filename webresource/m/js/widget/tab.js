    ...
    el: <div class="cp_tab {className}">
        <div class="cp_tab__head bottom_border">
            <ul class="cp_tab__head_con">
                <li class="cp_tab__head_item" sn-repeat="item in items">{item}</li>
            </ul>
        </div>
        <div class="cp_tab__body">
            <div class="cp_tab__content">
                <div class="cp_tab__item" sn-repeat="item in items" ref="items"></div>
            </div>
        </div>
    </div>,
