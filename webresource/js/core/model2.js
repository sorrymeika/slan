...
var ViewModelProto = {
    ...
    observe: function(key, fn) {
        ...
        return this.on(DATACHANGED_EVENT + key, fn);
    },
    ...
    removeObserve: function(key, fn) {
        ...
        return this.off(DATACHANGED_EVENT + key, fn);
    },
    ...
    updateView: function() {
        ...
        console.time('updateView-' + this.cid);
        ...
        console.timeEnd('updateView-' + this.cid);
